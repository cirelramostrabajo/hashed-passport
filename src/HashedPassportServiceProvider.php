...
use Cirelramostrabajo\HashedPassport\Commands\Install;
use Cirelramostrabajo\HashedPassport\Commands\Uninstall;
use Cirelramostrabajo\HashedPassport\Observers\ClientObserver;
